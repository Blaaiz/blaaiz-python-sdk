...
def update_version(new_version: str) -> None:
    ...
    for update in version_updates:
        ...
        try:
            ...
            if update["file"] == "pyproject.toml":
                updated_content = re.sub(update["pattern"], update["replacement"], content, flags=re.MULTILINE)
            else:
    ...
    print(f"\nNext steps:")
    print(f"1. Run tests to verify everything works: python -m pytest tests/test_version_consistency.py")
